...
{	
		//Channel：选择通道（1-10）
		//传入单精度浮点数
//	DataScope_Get_Channel_Data((float) vision.yaw.kal.imu_speed/13.0f , 1 );
//	DataScope_Get_Channel_Data((float) vision.yaw.kal.aim_speed , 2 );
//	DataScope_Get_Channel_Data((float) vision.yaw.kal.abs_speed,3 );
//	DataScope_Get_Channel_Data((float) vision.yaw.predict,4 );
	DataScope_Get_Channel_Data((float)  gimbal.pid.pit_ecd_ref, 1 );
	DataScope_Get_Channel_Data((float) gimbal.pid.yaw_angle_ref , 2 );
	DataScope_Get_Channel_Data((float) vision.yaw.angle_error[1],3 );
	DataScope_Get_Channel_Data((float) vision.yaw.kal.angle_error,4 );
