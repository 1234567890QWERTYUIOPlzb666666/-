...
typedef enum
{
  ...
  CAN_PIT_MOTOR_ID     = 0x206, 
	...
	CAN_TRIGGER_MOTOR2_ID= 0x208,
	
	CAN_SUPPLY_POWER_ID  = 0x003,
	CAN_CHASSIS_POWER_ID = 0x004,	
	CAN_SHOOOT_DATA_ID   = 0x005,
...
__BSP_CAN_EXT moto_measure_t motor_trigger2;
...
extern void can2_send(int16_t TX_ID,uint8_t power_limet,uint8_t ID,int16_t cooling_heat_limet,int16_t speed_limit,int16_t cooling_rate);
